...
SCENARIOS = [
    ...
    },
    {
        ...
        "eval_fn": lambda d: (
            _used_tool(d, "read_workspace_file")
            or _used_tool(d, "write_workspace_file"),
...
def run_scenario(
    client: httpx.Client, s: dict, idx: int, total: int, pause: bool
) -> bool:
...
def main():
    ...
    parser.add_argument(
        "--scenario", type=int, default=None, help="Run only scenario N (1-indexed)"
    )
